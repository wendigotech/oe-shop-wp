...
<div class="mb-3"><span class="me-2 text-warning"><?php $product_rating_rounded = PG_WC_Helper::roundToHalfStar( $product_rating ); ?><?php for($product_rating_star = 1; $product_rating_star <= $product_rating_rounded; $product_rating_star++ ) : ?><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em">
                <g>
